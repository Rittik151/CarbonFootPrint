...
export default function UserCalculations({ calculations: propCalculations }) {
  ...
  return (
    <section
      className="user-calculations"
      style={{ backgroundColor: "#4e9289ff", marginTop: 30 }}
    >
        ...
        {!loading && !error && (
          <>
            {sortedCalculations.length === 0 ? (
              <div className="stats-card" style={{ color: "#2e7d32" }}>
                No calculations yet.
              </div>
            ) : (
              <div
                      ...
                      try {
                        const d =
                          typeof c.details === "string"
                            ...
                            : c.details;
                        detailsText =
                          d?.diet || d?.Diet || JSON.stringify(d) || "-";
